            ...
            >
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="font-bold text-lg tracking-tight text-indigo-950 dark:text-white">SplitMate</span>
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <div className="flex items-center">
              <button
                ...
                className="hidden sm:inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold bg-indigo-50 text-indigo-700 hover:bg-indigo-100 dark:bg-indigo-950 dark:text-indigo-300 dark:hover:bg-indigo-900 border border-indigo-200 dark:border-indigo-800 transition-colors"
              >
              ...
              <button
                ...
                className="ml-2 inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold bg-indigo-600 hover:bg-indigo-700 text-white shadow-lg shadow-indigo-100 dark:shadow-none transition-all hover:scale-105 active:scale-95"
              >
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              >
                ...
                <div className="hidden lg:block text-left pr-1">
                  ...
                  <div className="text-[10px] text-indigo-600 dark:text-indigo-400 font-semibold leading-none">
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 py-3 z-50 animate-in fade-in zoom-in-95 duration-150">
                  ...
                  {/* Switch Active Student Account (Interactive Multi-Party Test) */}
                  <div className="p-3">
